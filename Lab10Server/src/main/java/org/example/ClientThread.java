...
public class ClientThread extends Thread {
                    ...
                    case "help":
                        sendResponse("""
                                ...
                                4.Available Commands for Players:
                                  ...
                                  "tournament" <n> <p> <d> to get a schedule and winner sequence.
                                5.Ending the Game:
                                  The game ends when you see the message “The winner is: 'X'!”
                                Enjoy the game!""");
                        break;
                    case "tournament":
                        sendResponse(server.solveTournament(Integer.parseInt(commandParts[1]),
                                Integer.parseInt(commandParts[2]),
                                Integer.parseInt(commandParts[3])));
                        sendResponse("The sequence in order of winners: " + server.findSequence());
                        break;
                    default:
    ...
    private boolean isValidCommand(String[] commandParts) {
        return switch (commandParts[0]) {
            ...
            case "tournament" -> commandParts.length == 4;
            case "stop", "exit", "help" -> true;
            default -> false;
        };
    }
    ...
    private String getErrorMessage(String command) {
        return switch (command) {
            ...
            case "tournament" -> "Error: 'tournament' command requires <n> <p> <d>.";
