...
public class GameServer {
    ...
    public String solveTournament(int n, int p ,int d) throws GRBException {
        tournamentScheduler = new TournamentScheduler(n, d, p);
        return tournamentScheduler.getScheduleSolution();
    }

    public String findSequence() throws GRBException {
        return tournamentScheduler.findSequenceForTournament();
    }
